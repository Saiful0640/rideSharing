...
import 'package:riderapp/Assistants/requestAssistan.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void findPlace(String placeName)async{
    if(placeName.length>1){
      String autoCompletUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=1234567890&components=country:bd";
      ...
      if(res["status"] == "OK"){
        var predicttions = res["predictions"];
        
        var placesList = (predicttions as List).map((e) => PlacePredictions.fromJson(e)).toList();
